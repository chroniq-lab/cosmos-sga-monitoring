...
ggarrange(a1c_plot,
  ...
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/relative rates of monitoring with cci category and encounter frequency.png"),width=7,height =6)
...
ggarrange(a1c_plot,
          ...
          ncol=2,
          common.legend = TRUE,legend = "bottom") %>% 
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/jpg/relative rates of monitoring with cci category and encounter frequency.jpg"),width=7,height =6)
