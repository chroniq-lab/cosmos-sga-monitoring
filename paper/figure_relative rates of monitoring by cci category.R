...
ggarrange(a1c_plot,
          ...
          ncol=2,
          common.legend = TRUE,legend = "bottom") %>% 
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/jpg/mild comorbidity relative rates of monitoring.jpg"),width=7,height =6)
...
ggarrange(a1c_plot,
          ...
          ncol=2,
          common.legend = TRUE,legend = "bottom") %>% 
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/jpg/moderate comorbidity relative rates of monitoring.jpg"),width=7,height =6)
