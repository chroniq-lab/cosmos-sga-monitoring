...
fig_df <- read_csv(paste0(path_sga_dm_control_folder,"/working/sdcan05/sdcan05c_model3 with dx_rx and cci category.csv")) %>% 
...
ggarrange(a1c_plot,
  ...
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/relative rates of monitoring with cci category.png"),width=7,height =6)
...
ggarrange(a1c_plot,
          ...
          ncol=2,
          common.legend = TRUE,legend = "bottom") %>% 
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/jpg/relative rates of monitoring with cci category.jpg"),width=7,height =6)
