...
ggarrange(a1c_plot,
  ...
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/low comorbidities modeled rates of outcomes screening by AP type.png"),width=8,height =6)
...
ggarrange(a1c_plot,
          ...
          ncol=2,
          common.legend = TRUE,legend = "right") %>% 
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/medium comorbidities modeled rates of outcomes screening by AP type.png"),width=8,height =6)
...
ggarrange(a1c_plot,
          ...
          ncol=2,
          common.legend = TRUE,legend = "right") %>% 
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/high comorbidities modeled rates of outcomes screening by AP type.png"),width=8,height =6)
