...
fig_df <- bind_rows(read_csv(paste0(path_sga_dm_control_folder,"/working/sdcan03/sdcan03ca_modeled probability of abc with bmi history.csv")),
                    read_csv(paste0(path_sga_dm_control_folder,"/working/sdcan03/sdcan03cb_modeled probability of abc with bmi history.csv")),
                    read_csv(paste0(path_sga_dm_control_folder,"/working/sdcan03/sdcan03db_modeled probability of complications with bmi history.csv")),
                    read_csv(paste0(path_sga_dm_control_folder,"/working/sdcan03/sdcan03da_modeled probability of complications with bmi history.csv"))) %>% 
...
bp_df <- under_df %>% dplyr::filter(outcome == "BP")
...
neur_df <- under_df %>% dplyr::filter(outcome == "Neuropathy")
...
reti_df <- under_df %>% dplyr::filter(outcome == "Retinopathy")
...
ancp_df <- under_df %>% dplyr::filter(outcome == "Any complications")
...
ggarrange(a1c_plot,
  ...
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/underweight modeled rates of outcomes screening by AP type.png"),width=12,height =5.5)
...
bp_df <- over_df %>% dplyr::filter(outcome == "BP")
bp_plot <- ggplot(bp_df, aes(x = period, y = predicted, group = ap_type, color = ap_type)) +
  geom_line() +  
  geom_point() +  
  geom_errorbar(aes(ymin = ci_low, ymax = ci_high), width = 0.2) +  
...
neur_df <- over_df %>% dplyr::filter(outcome == "Neuropathy")
neur_plot <- ggplot(neur_df, aes(x = period, y = predicted, group = ap_type, color = ap_type)) +
  geom_line() +  
  geom_point() +  
  geom_errorbar(aes(ymin = ci_low, ymax = ci_high), width = 0.2) +  
...
reti_df <- over_df %>% dplyr::filter(outcome == "Retinopathy")
reti_plot <- ggplot(reti_df, aes(x = period, y = predicted, group = ap_type, color = ap_type)) +
  geom_line() +  
  geom_point() +  
  geom_errorbar(aes(ymin = ci_low, ymax = ci_high), width = 0.2) +  
...
ancp_df <- over_df %>% dplyr::filter(outcome == "Any complications")
ancp_plot <- ggplot(ancp_df, aes(x = period, y = predicted, group = ap_type, color = ap_type)) +
  geom_line() +  
  geom_point() +  
  geom_errorbar(aes(ymin = ci_low, ymax = ci_high), width = 0.2) +  
...
ggarrange(a1c_plot,
          ...
          ncol=4,
          common.legend = TRUE,legend = "right") %>% 
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/overweight modeled rates of outcomes screening by AP type.png"),width=12,height =5.5)
...
bp_df <- obese_df %>% dplyr::filter(outcome == "BP")
bp_plot <- ggplot(bp_df, aes(x = period, y = predicted, group = ap_type, color = ap_type)) +
  geom_line() +  
  geom_point() +  
  geom_errorbar(aes(ymin = ci_low, ymax = ci_high), width = 0.2) +  
...
neur_df <- obese_df %>% dplyr::filter(outcome == "Neuropathy")
neur_plot <- ggplot(neur_df, aes(x = period, y = predicted, group = ap_type, color = ap_type)) +
  geom_line() +  
  geom_point() +  
  geom_errorbar(aes(ymin = ci_low, ymax = ci_high), width = 0.2) +  
...
reti_df <- obese_df %>% dplyr::filter(outcome == "Retinopathy")
reti_plot <- ggplot(reti_df, aes(x = period, y = predicted, group = ap_type, color = ap_type)) +
  geom_line() +  
  geom_point() +  
  geom_errorbar(aes(ymin = ci_low, ymax = ci_high), width = 0.2) +  
...
ancp_df <- obese_df %>% dplyr::filter(outcome == "Any complications")
ancp_plot <- ggplot(ancp_df, aes(x = period, y = predicted, group = ap_type, color = ap_type)) +
  geom_line() +  
  geom_point() +  
  geom_errorbar(aes(ymin = ci_low, ymax = ci_high), width = 0.2) +  
...
ggarrange(a1c_plot,
          ...
          ncol=4,
          common.legend = TRUE,legend = "right") %>% 
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/obese modeled rates of outcomes screening by AP type.png"),width=12,height =5.5)
