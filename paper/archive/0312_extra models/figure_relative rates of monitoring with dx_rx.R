...
fig_df <- read_csv(paste0(path_sga_dm_control_folder,"/working/sdcan05/sdcan05b_model2 with dx_rx.csv")) %>% 
...
ggarrange(a1c_plot,
  ...
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/relative rates of monitoring with dx_rx.png"),width=8,height =6)
