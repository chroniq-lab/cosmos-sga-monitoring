...
ggarrange(a1c_plot,
  ...
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/underweight modeled rates of outcomes screening adjust for comorbidities by AP type.png"),width=12,height =5.5)
...
ggarrange(a1c_plot,
          ...
          ncol=3,
          common.legend = TRUE,legend = "right") %>% 
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/overweight modeled rates of outcomes screening adjust for comorbidities by AP type.png"),width=12,height =5.5)
...
ggarrange(a1c_plot,
          ...
          ncol=3,
          common.legend = TRUE,legend = "right") %>% 
  ggsave(.,filename=paste0(path_sga_dm_control_folder,"/figures/obese modeled rates of outcomes screening adjust for comorbidities by AP type.png"),width=12,height =5.5)
