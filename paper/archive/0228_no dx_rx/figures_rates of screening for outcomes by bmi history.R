...
fig_df <- bind_rows(read_csv(paste0(path_sga_dm_control_folder,"/working/sdcan03/sdcan03ca_modeled probability of abc with bmi history.csv")),
                    ...
                    read_csv(paste0(path_sga_dm_control_folder,"/working/sdcan03/sdcan03dc_modeled probability of any 5 outcomes with bmi history.csv"))) %>% 
...
anout5_df <- under_df %>% dplyr::filter(outcome == "Any 5 outcomes")
...
anout5_df <- over_df %>% dplyr::filter(outcome == "Any 5 outcomes")
anout5_plot <- ggplot(anout5_df, aes(x = period, y = predicted, group = ap_type, color = ap_type)) +
  geom_line() +  
  geom_point() +  
  geom_errorbar(aes(ymin = ci_low, ymax = ci_high), width = 0.2) +  
...
anout5_df <- obese_df %>% dplyr::filter(outcome == "Any 5 outcomes")
anout5_plot <- ggplot(anout5_df, aes(x = period, y = predicted, group = ap_type, color = ap_type)) +
  geom_line() +  
  geom_point() +  
  geom_errorbar(aes(ymin = ci_low, ymax = ci_high), width = 0.2) +  
